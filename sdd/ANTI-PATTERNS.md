...
**Scribobulate**: `sdd/PLAN.crash-recovery.md` § "RESOLVED: the write mechanism" carries the decision, the durability table and the route-C mitigation. No implementation yet.
