...
| `codeview/` | Owns `CodePreviewView`, the preview's `GtkTextView` subclass that self-draws code-block backgrounds and their copy buttons, task checkboxes, list markers and the right-margin annotation chips. |
