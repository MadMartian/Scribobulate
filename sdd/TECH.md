...
| `renderer/rawhtml.rs` | Owns the raw-HTML **allowlist** — the single statement of which elements survive sanitisation-by-omission. One owner because the permitted set is a security posture, and it feeds two scanners and two sinks. |
