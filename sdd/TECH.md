...
| `window/foldreveal.rs` | Owns making content inside a collapsed disclosure reachable: expanding the folds that hide it, re-rendering, and running the caller's navigation against the render that results. |
