...
- [ ] **25.17** Export a document containing a table wider than the printable width → the table is scaled to fit, not clipped at the margin and not reflowed (TDD 25.17)
